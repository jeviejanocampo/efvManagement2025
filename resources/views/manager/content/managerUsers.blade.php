...
<div class="bg-white p-4 rounded-md" style="box-shadow: 4px 4px 10px rgba(0, 0, 0, 0.2);">
    ...
    <div class="flex justify-between items-center mb-4">
        ...
        <a href="{{ route('manager.users.create') }}" class="flex items-center bg-black text-white px-4 py-2 rounded hover:bg-gray-800" title="Add User">
    ...
    <table class="min-w-full border-b border-gray-300">
        ...
        <tbody>
            ...
            <tr class="text-sm text-gray-800">
                ...
                <td class="px-4 py-2">
                    <a href="{{ route('manager.users.edit', $user->id) }}" class="text-blue-500 hover:text-blue-700" title="Edit User">
