...
<div class="bg-white p-4 shadow-md">
    <h2 class="text-3xl font-semibold mb-4">Customer Management</h2>
        ...
        <table class="min-w-full text-sm text-left text-gray-700">
            <thead class="bg-gray-100 text-xs uppercase font-semibold">
                <tr>
                    ...
                    <th class="px-4 py-2 border-b text-center">Action</th> {{-- 🔧 New column --}}
                </tr>
            </thead>
                ...
                @foreach ($users as $user)
                    <tr class="hover:bg-gray-50">
                        <td class="px-4 py-2 border-b">
                            <i class="fas fa-user mr-1 text-gray-500"></i>{{ $user->full_name }}
                        </td>
...
<script>
    function filterTable() {
        ...
        rows.forEach(row => {
            ...
            const createdDate = cells[6]?.innerText.trim();       // ✅ Corrected index
            const statusText = cells[7]?.innerText.toLowerCase(); // ✅ Corrected index
