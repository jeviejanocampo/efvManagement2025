...
<div class="p-4 ">
    ...
    @endphp -->
        ...
        <div class="space-y-4 no-print">
            ...
            <div id="editStatusModal" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 hidden">
                <div class="bg-white p-6 rounded-lg w-full max-w-sm shadow-xl">
                    ...
                    <form method="POST" action="{{ route('manager.updatePaymentStatus') }}">
                        @csrf
        ...
        <div id="paymentMethodModal" class="fixed inset-0 flex justify-center items-center bg-black bg-opacity-50 hidden">
            <div class="bg-white p-6 w-1/3">
                ...
                <form id="gcashPaymentForm" method="POST" action="{{ route('manager.saveGcashPayment') }}" enctype="multipart/form-data" onsubmit="return handlePaymentSubmit(event)">
                    @csrf
    ...
    <div class ="bg-white p-4 border-b border-gray pb-4 ">
        ...
        <div class="flex justify-between items-center">
            ...
            <a href="{{ route('manager.edit.product', ['order_id' => $orderDetails->first()->order_id]) }}" class="bg-black no-print text-white px-2 py-2 text-sm hover:bg-blue-600 transition">
...
<script>
    ...
    function fetchPaymentImage(order_id, payment_method) {
        fetch(`/manager/payment-image/${order_id}/${payment_method}`)
