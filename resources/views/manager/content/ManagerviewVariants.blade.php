...
<div class="container mx-auto p-6 bg-white rounded-xl shadow-md">
    ...
    <div>
        <a href="{{ route('manager.add.variant', ['model_id' => $model_id]) }}">
            ...
            <tbody>
                @foreach ($variants as $variant)
                    <tr>
                        ...
                        <td class="border border-gray-300 px-2 py-1 text-center">
                        <a href="{{ route('manager.edit.variant', ['model_id' => $variant->model_id, 'variant_id' => $variant->variant_id]) }}" class="text-blue-500 hover:underline">
                            Edit
                        </a>
                            | 
