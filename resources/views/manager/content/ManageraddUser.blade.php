...
<div class="bg-white p-4 rounded-md" style="box-shadow: 4px 4px 10px rgba(0, 0, 0, 0.2);">
    ...
    <a href="{{ route('manager.users') }}" class="inline-flex items-center text-black hover:text-blue-800 pb-4">
            <i class="fas fa-arrow-left mr-2"></i> 
        </a>

    <h1 class="text-4xl font-semibold mb-4 border-b border-gray pb-2">Add User</h1>

    <form id="addUserForm" action="{{ route('manager.users.store.user') }}" method="POST">
        @csrf
