...
<div class="bg-white p-4 rounded-md" style="box-shadow: 4px 4px 10px rgba(0, 0, 0, 0.2);">
    ...
    <div class="p-4 bg-white flex items-center justify-between">
        ...
        <a href="{{ route('admin.request.replacement.form') }}">
        ...
        <tr class="border text-gray-700 text-sm">
            ...
            <td class="py-3 px-4 border-b">
                ...
                @if ($refund->orderReference)
                    {{ $refund->orderReference->reference_id }}OR00{{$refund->order_id }}
            ...
            <td class="py-3 px-4 border-b">
                <a href="{{ route('admin.refundRequestForm', ['order_id' => $refund->order_id, 'reference_id' => $refund->orderReference ? $refund->orderReference->reference_id : null]) }}" 
