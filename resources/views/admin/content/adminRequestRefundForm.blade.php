...
<a href="{{ route('admin.refundRequests') }}" class="bg-gray-800 text-white px-2 py-1 rounded-full hover:bg-gray-700 items-center gap-2">
        ...
        <div class="order-details">
            ...
            <div class="flex justify-between items-center border-b border-gray-300 pb-4">
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <form action="{{ route('admin.updateRefundStatus', $refund->order_id) }}" method="POST" class="flex items-center space-x-2">
                        @csrf
                    ...
                    <div class="space-y-10">
                        ...
                        <div class="mt-1">
                            <p class="text-1xl"><strong>Refunded Amount:</strong>
                                <span class="
                                    @if(strtolower($refund->refund_method) === 'completed')
            ...
            <form method="POST" action="{{ route('admin.order.updateStatus.refunded') }}">
                @csrf
