            ...
            <tbody class="text-gray-700">
                @foreach ($refunds as $refund)
                    <tr class="border-b hover:bg-gray-100 refundRow">
                        <td class="py-3 px-4">
                            {{ $refund->orderReference?->reference_id ?? 'ORD000' . $refund->refund_id }}OR000{{ $refund->order_id }}
                        </td>
                        <td class="py-3 px-4">
                        ...
                        <td class="py-3 px-4 text-center">
                            <a href="{{ route('admin.refund.view.details', ['order_id' => $refund->order_id, 'reference_id' => $refund->orderReference?->reference_id ?? 'N/A']) }}" class="text-white hover:text-blue-800 bg-blue-500 p-2 rounded-lg">
