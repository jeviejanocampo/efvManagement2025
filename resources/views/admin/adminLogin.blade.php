...
<div class="bg-white  rounded-lg w-full max-w-3xl flex ">
        ...
        <div class="w-1/2 p-6">
            ...
            <form action="{{ route('admin.login.submit') }}" method="POST">
                ...
                <input type="text" id="name" name="name" class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-gray-300" placeholder="Enter your username" required>
                </div>
                <div class="mb-4">
