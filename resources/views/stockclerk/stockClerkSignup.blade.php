...
<body class="text-white flex items-center justify-center min-h-screen">
    ...
    <div class="w-full max-w-md bg-gray-800 p-8 rounded-lg shadow-lg">
        <h1 class="text-2xl font-bold mb-6 text-center">Stock Clerk Signup</h1>
        <form action="{{ route('staff.signup.submit') }}" method="POST">
            @csrf
            <div class="mb-4">
            ...
            <div class="mt-4 text-center">
                <a href="/stock-clerk/login" class="text-sm text-gray-400 hover:text-white underline">
                    Back to Login
                </a>
            </div>
        </form>
