...
<div class="p-4 ">
    ...
    @endphp -->
        ...
        <div class="space-y-4 no-print">
            ...
            <p style="font-size: 14px">
                ...
                onclick="openModalUser({{ $order->user_id }})">
                    View Details
                </a>
            </p>
    ...
    <div class ="bg-white p-4 border-b border-gray pb-4 ">
        ...
        <div class="flex justify-between items-center">
            ...
            <a href="{{ route('edit.product', ['order_id' => $orderDetails->first()->order_id]) }}" class="bg-black no-print text-white px-2 py-2 text-sm hover:bg-blue-600 transition">
    ...
    <div id="userModal" class="fixed inset-0 flex justify-center items-center bg-black bg-opacity-50 hidden">
        <div class="bg-white p-6 rounded-lg w-1/3">
            ...
            <button onclick="closeModalUser()" class="mt-4 bg-gray-800 text-white px-5 py-2 ">Close</button>
        </div>
    </div>
